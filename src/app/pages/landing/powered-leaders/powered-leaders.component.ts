...
export class PoweredLeadersComponent {
  partners = [
    { link : 'https://iq.wiki/wiki/ozarus', name: 'wiki', logo: 'assets/logos/wiki.jpeg' },
      ...
      { link : 'https://www.neurochain.ai/', name: 'neurochain', logo: 'assets/logos/neurochain.jpeg' },
      ...
      { link : 'https://bubblemaps.io/', name: 'bubblemaps', logo: 'assets/leaders/dj1tOY36_400x400.jpg' },
